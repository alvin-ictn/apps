...
const auto_grow = (element) => {
   ...
   my_label.style.transform = `translate(${element.scrollHeight > 28  && screen.width <= 580 ? (screen.width/2 - 65) : element.scrollHeight > 28 && screen.width > 581 ? 290-65 : 0}px, -${element.scrollHeight-10}px)`;
